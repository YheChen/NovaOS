...
export const INSTRUCTION_SPECS: Record<string, InstructionSpec> = {
  ...
  BAND: { opcode: Opcode.BAND, operands: ['register', 'register', 'register'] },
  BOR: { opcode: Opcode.BOR, operands: ['register', 'register', 'register'] },
  BXOR: { opcode: Opcode.BXOR, operands: ['register', 'register', 'register'] },
  SHL: { opcode: Opcode.SHL, operands: ['register', 'register', 'register'] },
  SHR: { opcode: Opcode.SHR, operands: ['register', 'register', 'register'] },
